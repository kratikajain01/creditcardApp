...
@InjectMocks
	...
	public void saveCard_cardAlreadyExist() {
		...
		assertEquals("12435436546 Credit Card details already Exists",
	...
	public void saveCard_cardLengthFails() {
		...
		ApplicationException entityExistException = assertThrows(ApplicationException.class,
				() -> creditCardService.saveCard(creditCard));
		assertEquals("Length of credit card should be 19 or less",
	...
	public void saveCard_success() throws Exception {
		...
		assertEquals(creditCard, creditCardService.saveCard(creditCard));
	}
